...
I have played this game for months now and have reached level 90 which gives me the confidence to say that I'm fairly skilled and experienced in this game. Note that the peak [server](https://discord.gg/peakdev) provides a helpful community with a bunch of people who are higher level than I am.
...
20 : Bruiser, Playmaker, Trigger finger

30 : Medic, Playmaker, Trigger finger

45 : Medic, Fortifier, Heavy hitter

60 : Medic, Adrenaline rush, Fortifier, Heavy hitter

85 : Adrenaline rush, Speed demon, Carpenter, Fortifier, Heavy hitter

100 : Holy trinity(Guardian angel, Juggernaut, Overwatch), Speed demon, Carpenter, Fortifier

You can now forge your own build with the recommended perks. For the list of perks here's the [wiki](https://those-who-remain.fandom.com/wiki/Perks).
